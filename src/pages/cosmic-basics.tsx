...
export default function Page() {
  ...
  var content = (<><h1>COSMIC BASICS</h1>
    <p>The Cosmic Mesh is a <strong>facade</strong> where <strong>everything</strong> inside & outside of the Mesh is a bindable, pointable <em>[addressable]</em>, waveable <em>[messageable]</em> resource called a <strong>Particle</strong></p>
